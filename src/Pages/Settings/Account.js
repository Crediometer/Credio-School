                            ...
                            <form>
                                <div className="director-form">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="21" viewBox="0 0 17 21" fill="none">
                                        ...
                                        <input type='text' value={getprofile?.schoolProfile?.schoolName}></input>
                                    </div>
                                </div>
                                {/* <div className="director-form">
                                ...
                                <div className="director-form">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="21" viewBox="0 0 23 21" fill="none">
                                        ...
                                        <input type='text' value='TestVenture@gmail.com'></input>
                                    </div>
                                </div>
                                <div className="director-form ">
                                    ...
                                    <div className="director-form-2">
                                        ...
                                        <div className="director-form-phone">
                                            <div className="director-form-select">
                                            <input type='Text' value={getprofile?.schoolProfile?.phoneNumber}></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
